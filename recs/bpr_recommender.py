...
class BPRRecs(base_recommender):
    def __init__(self, save_path='./builder/models/bpr/19/model/'):
    ...
    def recommend_items_by_ratings(self, user_id, active_user_items, num=6):
        ...
        rated_books = {book['book_id']: book['rating']
                        for book in active_user_items}
        recs = {}
