...
class DescriptionField(models.TextField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['verbose_name'] = kwargs.get('verbose_name', 'Description')
...
class ModifierCharField(models.CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['null'] = kwargs.get('null', True)
        kwargs['blank'] = kwargs.get('blank', True)
        kwargs['verbose_name'] = kwargs.get('verbose_name', 'editor')
        kwargs['help_text'] = kwargs.get('help_text', 'The record was last modified by')
        super().__init__(*args, **kwargs)
